...
@Composable
fun LastSundayPost(handleNavigateHome: () -> Unit) {
    ...
    Column(
        ...
        Text(text = "Post About Last Sunday")
        Spacer(modifier = Modifier.padding(5.dp))

        Text(
            text = "Last sunday posts help those members who did not attend the service to easily figure out what the preacher ministered.",
        ...
        OutlinedTextField(
            ...
            label = {
                Text(text = "What was the Theme or Title")
            },

            placeholder = {
                Text(text = "Repentance, Thanks Giving, Fasting e.t.c")
            },
        ...
        Button(
            onClick = {
                ...
                if (currentUserID != null) {
                    fireStore.collection(FirebaseConfig.fireStoreLastSunday).document(currentUserID)
